...
export default function AuthService($location, $http, $cookies, $q, appConfig, Util, User) {
  'ngInject';
  ...
  const Auth = {
    ...
    changePassword(oldPassword, newPassword, callback ?: Function) {
      return User.changePassword(
        { id: currentUser._id }, // eslint-disable-line no-underscore-dangle
