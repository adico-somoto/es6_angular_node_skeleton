...
export function Modal($rootScope, $uibModal) {
  ...
  function openModal(scope = {}, modalClass = 'modal-default') {
    ...
    return $uibModal.open({
      template: require('./modal.html'), // eslint-disable-line global-require
  ...
  return {
    ...
    confirm: {
      ...
      delete(del = angular.noop) {
         ...
         * @param  {All}           - any additional args are passed straight to
         * del callback
         */
        return (...args) => {
...
export default angular.module('workApp.Modal', [])
  .factory('Modal', Modal)
  .name;
